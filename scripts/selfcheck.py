...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as skill_target:
        checks = [
            ...
            [
                ...
                "json",
                "--output",
                "examples/outputs/visual_capture_audit.json",
            ],
            [
                sys.executable,
                "-m",
                ...
                "markdown",
                "--output",
                "examples/outputs/visual_capture_audit.md",
            ],
            [
                sys.executable,
                "-m",
    ...
    required_showcase_files = [
        ...
        root / "examples/outputs/visual_capture_audit.md",
        root / "examples/outputs/visual_capture_audit.json",
        root / "examples/outputs/visual_capture_compare.md",
        root / "examples/outputs/visual_capture_compare.json",
        root / "examples/outputs/visual_release_checklist.md",
        root / "examples/outputs/visual_release_checklist.json",
